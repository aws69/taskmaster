...
public final class Task implements Model {
  ...
  public Task(String id, String name, String body, TaskState state) {
    this.id = id;
    this.name = name;
    this.body = body;
    this.state = state;
  ...
  public static class Builder implements NameStep, BuildStep {
    ...
    private Builder(String id, String name, String body, TaskState state) {
      this.id = id;
      this.name = name;
      this.body = body;
      this.state = state;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String body, TaskState state) {
